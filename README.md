...
| **GitHub Pages mirror** | https://aritrade.github.io/productiveyou/ |
...
├── .github/workflows/
│   └── deploy-pages.yml      # Auto-deploy the app to aritrade.github.io/productiveyou/ on every push to main
